// lib/pharmacy/category-brand-helpers.ts
...
export function formatCategoryType(medicineType: string): string {
  return medicineType.charAt(0).toUpperCase() + medicineType.slice(1);
}