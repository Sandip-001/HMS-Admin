// app/(main)/emergency/dashboard/_components/emergency-charts.tsx
"use client";
    ...
    <Card className="border-slate-200 shadow-lg">
      ...
      <CardContent>
        <ResponsiveContainer width="100%" height={300}>
          <AreaChart data={data}>
            <defs>
              <linearGradient id="erRevenueGradient" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#e11d48" stopOpacity={0.35} />
                <stop offset="95%" stopColor="#e11d48" stopOpacity={0} />
              </linearGradient>
              <linearGradient id="erCollectedGradient" x1="0" y1="0" x2="0" y2="1">
...
export function ArrivalDischargeChart({
  data,
}: {
  data: DailyEmergencyTrendPoint[];
}) {
      ...
      <CardContent>
        <ResponsiveContainer width="100%" height={300}>
          <BarChart data={data}>
            ...
            <Bar dataKey="arrivals" name="Arrivals" fill="#8b5cf6" radius={[6, 6, 0, 0]} />
        ...
        <ResponsiveContainer width="100%" height={300}>
          <BarChart data={data} layout="vertical" margin={{ left: 10 }}>
            ...
            <Bar dataKey="occupied" name="Occupied" stackId="bed" radius={[0, 0, 0, 0]}>
              {data.map((entry: EmergencyBayOccupancy) => (
