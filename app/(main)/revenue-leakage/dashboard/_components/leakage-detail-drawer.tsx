...
function isGrandTotalRow(row: DrawerRow): row is GrandTotalRow {
  return (
    "category" in row && "amount" in row && !("estimatedLossAmount" in row)
  );
}
    ...
    switch (type) {
      case "totalDiscount":
        return {
          ...
          subtitle:
            "Every discount given by Billing, Pharmacy, and Lab departments",
          ...
          columns: [
            ...
            },
            {
              ...
              render: (row) => (isDiscountRecord(row) ? row.billNumber : "-"),
            },
            {
              key: "totalBillAmount",
              label: "Total Bill",
              ...
              render: (row) =>
                isDiscountRecord(row)
                  ? `₹${row.totalBillAmount.toLocaleString("en-IN")}`
                  : "-",
            },
            {
            ...
            },
            {
              ...
              label: "Given At",
              defaultVisible: true,
              render: (row) => (isDiscountRecord(row) ? row.givenAt : "-"),
            },
          ],
        };
        ...
        return {
          ...
          columns: [
            ...
            },
            {
              ...
              label: "Category",
              defaultVisible: true,
              render: (row) => (isExpiredMedicine(row) ? row.category : "-"),
            },
            {
              key: "batchNumber",
              label: "Batch No.",
            ...
            },
            {
              ...
              label: "Expiry Date",
              defaultVisible: true,
              render: (row) => (isExpiredMedicine(row) ? row.expiryDate : "-"),
            },
            {
              key: "expiredQuantity",
              label: "Qty",
            ...
            },
            {
              ...
              defaultVisible: false,
              render: (row) =>
                isExpiredMedicine(row) ? `₹${row.unitPrice}` : "-",
            },
            {
              key: "totalLossAmount",
              label: "Total Loss",
              ...
              render: (row) =>
                isExpiredMedicine(row) ? (
                  <span className="font-bold text-red-600">
                    ₹{row.totalLossAmount.toLocaleString("en-IN")}
                  </span>
                ) : (
                  "-"
                ),
            },
            {
              ...
              label: "Rack",
              defaultVisible: false,
              render: (row) => (isExpiredMedicine(row) ? row.rackNumber : "-"),
            },
            {
              key: "detectedOn",
              label: "Detected On",
              defaultVisible: true,
              render: (row) => (isExpiredMedicine(row) ? row.detectedOn : "-"),
            },
            {
              key: "detectedBy",
              label: "Detected By",
              defaultVisible: false,
              render: (row) => (isExpiredMedicine(row) ? row.detectedBy : "-"),
            },
            {
              key: "status",
              label: "Status",
        ...
        return {
          ...
          columns: [
            ...
            },
            {
              ...
              label: "Doctor",
              defaultVisible: false,
              render: (row) => (isPendingBill(row) ? row.doctor : "-"),
            },
            {
              key: "totalBillAmount",
              label: "Total Bill",
              ...
              render: (row) =>
                isPendingBill(row) ? (
                  <span className="font-semibold text-emerald-600">
                    ₹{row.amountCollected.toLocaleString("en-IN")}
                  </span>
                ) : (
                  "-"
                ),
            },
            {
              ...
              render: (row) =>
                isPendingBill(row) ? (
                  <span className="font-bold text-red-600">
                    ₹{row.amountPending.toLocaleString("en-IN")}
                  </span>
                ) : (
                  "-"
                ),
            },
            {
              ...
              label: "Days Pending",
              defaultVisible: true,
              render: (row) => (isPendingBill(row) ? row.daysPending : "-"),
            },
            {
              key: "contactNumber",
              label: "Contact",
              defaultVisible: false,
              render: (row) => (isPendingBill(row) ? row.contactNumber : "-"),
            },
            {
              key: "status",
              label: "Status",
      ...
      case "otherLeakage":
        return {
          ...
          subtitle:
            "Unbilled consumables, waived charges, rejected claims, and more",
          ...
          columns: [
            ...
            },
            {
              ...
              label: "Department",
              defaultVisible: true,
              render: (row) => (isOtherLeakage(row) ? row.department : "-"),
            },
            {
              key: "patientName",
              label: "Patient",
            ...
            },
            {
              ...
              render: (row) =>
                isOtherLeakage(row) ? (
                  <span className="font-bold text-red-600">
                    ₹{row.estimatedLossAmount.toLocaleString("en-IN")}
                  </span>
                ) : (
                  "-"
                ),
            },
            {
              ...
              label: "Identified By",
              defaultVisible: false,
              render: (row) => (isOtherLeakage(row) ? row.identifiedBy : "-"),
            },
            {
              key: "identifiedOn",
              label: "Identified On",
              defaultVisible: false,
              render: (row) => (isOtherLeakage(row) ? row.identifiedOn : "-"),
            },
            {
              key: "status",
              label: "Status",
      ...
      case "departmentBreakdown":
        return {
          ...
          onExport: () =>
            exportDepartmentSummaryToExcel(data.departmentSummary),
          columns: [
            {
              key: "department",
              label: "Department",
            ...
            },
            {
              ...
              defaultVisible: true,
              render: (row) =>
                isDepartmentSummary(row)
                  ? `₹${row.discountLeakage.toLocaleString("en-IN")}`
                  : "-",
            },
            {
              key: "pendingLeakage",
              ...
              render: (row) =>
                isDepartmentSummary(row)
                  ? `₹${row.pendingLeakage.toLocaleString("en-IN")}`
                  : "-",
            },
            {
              key: "otherLeakage",
              ...
              render: (row) =>
                isDepartmentSummary(row)
                  ? `₹${row.otherLeakage.toLocaleString("en-IN")}`
                  : "-",
            },
            {
              key: "totalLeakage",
              ...
              render: (row) =>
                isDepartmentSummary(row) ? (
                  <span className="font-bold text-red-600">
                    ₹{row.totalLeakage.toLocaleString("en-IN")}
                  </span>
                ) : (
                  "-"
                ),
      ...
      case "staffBehavior":
        return {
          ...
          subtitle:
            "Monitor which staff members give discounts most frequently",
          rows: data.staffDiscountBehavior,
          onExport: () =>
            exportStaffBehaviorToExcel(data.staffDiscountBehavior),
          columns: [
            {
              key: "staffName",
              label: "Staff",
            ...
            },
            {
              ...
              render: (row) =>
                isStaffBehavior(row)
                  ? `₹${row.totalDiscountAmount.toLocaleString("en-IN")}`
                  : "-",
            },
            {
              ...
              defaultVisible: true,
              render: (row) =>
                isStaffBehavior(row) ? `${row.avgDiscountPercentage}%` : "-",
            },
            {
              key: "flagged",
              label: "Flag",
      ...
      case "grandTotal": {
        const grandTotalRows: GrandTotalRow[] = [
          { category: "Discounts", amount: data.summary.totalDiscountLeakage },
          {
            category: "Expired Medicines",
            amount: data.summary.totalExpiredMedicineLoss,
          },
          {
            category: "Pending Bill Amounts",
            amount: data.summary.totalPendingAmount,
          },
          {
            category: "Other Leakage Issues",
            amount: data.summary.totalOtherLeakage,
          },
        ];
