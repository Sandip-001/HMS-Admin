// app/admin/pharmacy/dashboard/_components/least-selling-medicines-chart.tsx
"use client";
...
export function LeastSellingMedicinesChart({ data }: { data: MedicineSalesItem[] }) {
  const sorted = [...data].sort((a, b) => b.unitsSold - a.unitsSold);

  return (
    <ChartCard title="Least Selling Medicines" subtitle="Slow-moving inventory items">
