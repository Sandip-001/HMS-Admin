...
export function RevenueProfitChart({ data }: { data: RevenueProfitPoint[] }) {
  return (
    <ChartCard title="Revenue vs Profit" subtitle="Monthly comparison of revenue and net profit">
      <ResponsiveContainer width="100%" height={300}>
        <BarChart data={data} margin={{ top: 5, right: 10, left: -10, bottom: 0 }}>
          ...
          <Bar dataKey="revenue" name="Revenue" fill="#6366f1" radius={[6, 6, 0, 0]} barSize={18} />
          <Bar dataKey="profit" name="Profit" fill="#10b981" radius={[6, 6, 0, 0]} barSize={18} />
        </BarChart>
      </ResponsiveContainer>
    </ChartCard>
  );
